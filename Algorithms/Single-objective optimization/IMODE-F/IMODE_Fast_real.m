classdef IMODE_Fast_real < ALGORITHM
...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            wave_rec=signal_rec(Problem.Data(1,:),1001,17);
            Ang=wave_find(wave_rec);
            PopDec = (Problem.upper-Problem.lower).*rand(Problem.N,Problem.D) + Problem.lower;
            PopDec(:,4)  = Ang(1)+pi/2;
            PopDec(:,5)  = Ang(2)+pi/2;
            PopDec(:,6)  = Ang(3)+pi/2;
